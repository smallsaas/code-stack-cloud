...
public class FieldModelEndpoint {
    ...
    public Tip createFieldModel(@RequestBody FieldModel entity) {
        Integer affected = 0;
        String[] Types = new String[]{"long","smallint","int","decimal","varchar"};
        List<String> list = Arrays.asList(Types);
        Assert.isTrue(list.contains(entity.getDataType()),"类型错误,请输入正确类型：[\"long\",\"smallint\",\"int\",\"decimal\",\"varchar\"]");
        try {
