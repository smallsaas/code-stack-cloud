...
public class DoSqlField extends Model<DoSqlField> {
    ...
    public DoSqlField setId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public DoSqlField setTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public DoSqlField setDescription(String description) {
    ...
    public DoSqlField setQueryFileName(String queryFileName) {
    ...
    public DoSqlField setExecutionFileName(String executionFileName) {
    ...
    public DoSqlField setParamStatus(Integer paramStatus) {
    ...
    public DoSqlField setSqlVersion(String sqlVersion) {
    ...
    public DoSqlField setNote(String note) {
        this.note = note;
        return this;
    }
    ...
    public DoSqlField setCreateTime(Date createTime) {
    ...
    public DoSqlField setUpdateTime(Date updateTime) {
