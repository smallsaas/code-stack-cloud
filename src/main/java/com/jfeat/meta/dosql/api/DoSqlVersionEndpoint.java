...
@RestController
@Api("DevVersion")
@RequestMapping("/api/adm/lc/dosql/versions")
public class DoSqlVersionEndpoint {

    @Resource
    DoSqlVersionService devVersionService;
    ...
    @PostMapping
    @ApiOperation(value = "新建 DevVersion", response = DoSqlVersion.class)
    public Tip createDevVersion(@RequestBody DoSqlVersion entity) {
        Integer affected = 0;
        try {
    ...
    @GetMapping("/{id}")
    @ApiOperation(value = "查看 DevVersion", response = DoSqlVersion.class)
    ...
    @PutMapping("/{id}")
    @ApiOperation(value = "修改 DevVersion", response = DoSqlVersion.class)
    public Tip updateDevVersion(@PathVariable Long id, @RequestBody DoSqlVersion entity) {
        entity.setId(id);
    ...
    @ApiOperation(value = "DevVersion 列表信息", response = DoSqlVersion.class)
    @GetMapping
    @ApiImplicitParams({
    ...
    public Tip queryDevVersionPage(Page<DoSqlVersion> page,
        ...
        List<DoSqlVersion> devVersionPage = queryDevVersionDao.findDevVersionPage(page, record, tag, search, orderBy, null, null);
